...
export class UsersController {
  ...
  @Validator(permissionsValidator({users: "id"}))
  ...
  @Validator(permissionsValidator({users: "id", roles: "rid"}))
  ...
  @Validator(permissionsValidator({users: "id", permissions: "permissionId"}))
